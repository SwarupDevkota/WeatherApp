...
// Get default weather report for Bridgend
getWeatherReport('Bridgend');
...
function showWeaterReport(weather) {
    ...
    if (city_code === '400') {
        ...
        console.log("No such city ", "Entered city not found", "warning");
        reset();
    } else {
        ...
        <div class="day-details">
            <div class="basic">Temperature ${weather.main.feels_like}&deg;C | Humidity ${weather.main.humidity}%<br>Pressure ${weather.main.pressure} mb | Wind ${weather.wind.speed} KMPH</div>
        </div>
        `;
